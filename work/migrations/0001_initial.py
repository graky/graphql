# Generated by Django 3.1.4 on 2021-09-15 09:27
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('creator', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='work.employer', verbose_name='Работодатель')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('closed_vacancies', models.IntegerField()),
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('exit_proof', models.BooleanField()),
                ('recruiter', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='work.recruiter')),
                ('vacancy', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='work.vacancy')),
            ],
        ),
    ]
